...
A first-author manuscript on runtime-adaptive neuro-fuzzy edge control with sampled-data stability analysis, in collaboration with the corresponding author, Xu Liu (China Aerospace Science and Industry Corporation, CASIC). Being developed for a control / automation venue.
